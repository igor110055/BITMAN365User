	...
	public function getAllPageLinks($count,$href) {
		...
		if($pages > 0) {
			if($_GET["page"] == 1) 
				...
				$output = $output . '<a class="link first" onclick="getresult(\'' . $href . (1) . '\')" ><img src="../assets/icons/arrow-backward.png"></a><a class="link" onclick="getresult(\'' . $href . ($_GET["page"]-1) . '\')" ><img src="../assets/icons/arrow-prev.png"></a>';
			...
			if($_GET["page"] < $pages)
				$output = $output . '<a  class="link" onclick="getresult(\'' . $href . ($_GET["page"]+1) . '\')" ><img src="../assets/icons/arrow-next.png"></a><a  class="link" onclick="getresult(\'' . $href . ($pages) . '\')" ><img src="../assets/icons/arrow-forward.png"></a>';
			else				
