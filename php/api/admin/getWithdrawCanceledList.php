<?php  
	...
	$sql = $query->getWithdrawCanceledList();
    $sql1 = $query->getWithdrawCanceledRowCount();
				
	$paginationlink = "../php/api/admin/getWithdrawCanceledList.php?page=";
    ...
    if($sql1->rowCount() > 0){
        foreach($data as $key => $val){
            ...
            $output .= '<td style="text-align: center; padding: 5px 5px; color: #FFFFFF; background: #ED5659;">'.number_format($val["t_Total_Amount_Cash_Out"], 2, '.', ',').'</td>';
