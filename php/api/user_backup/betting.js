            ...
            buttons: {
                bet: {
                    ...
                    action: function(){
                        ...
                        $.post( "php/api/admin/postPurchaserequest.php", JSON.stringify(arr), function( res ) {
                            var time = [{time: mytimeunix}];
                            $.post( "php/api/admin/checkTimeBetPerMin.php", JSON.stringify(time), function( res ) {
                                if(res.length > 0){
            ...
            buttons: {
                bet: {
                    ...
                    action: function(){
                        ...
                        $.post( "php/api/admin/postPurchaserequest.php", JSON.stringify(arr), function( response ) {
                            var time = [{time: mytimeunix}];
                            $.post( "php/api/admin/checkTimeBetPerMin.php", JSON.stringify(time), function( res ) {
                                if(res.length > 0){
                                    location.reload(true);
...
function getBettinghistory(){
    var html = '';
    $.ajax({
        "url": "php/api/admin/getBinanceHistory.php",
        "type": "GET",
...
function getBettinguserhistory(){
    ...
    var formatter = new Intl.NumberFormat();
    $.ajax({
        "url": "php/api/admin/getBinanceUserHistory.php",
        "type": "GET",
        "contentType": "application/json",
        "async": false,
        success: function(response) {
...
function getBettingHistoryGroup(){
    $.ajax({
        "url": "php/api/admin/getBettingHistoryGroup.php",
        "type": "GET",
        "contentType": "application/json",
        "async": false,
        success: function(response) {
            ...
            $(".btn_result").click(function(){
                ...
                $.ajax({
                    "url": "php/api/admin/getWssResultPerMin.php",
                    "type": "POST",
                    "contentType": "application/json",
                    "async": false,
