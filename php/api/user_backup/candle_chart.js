$(function(){
    ...
    ws.onmessage = (event) => {
        ...
        if(timesec > end){
            ...
            $.post("php/api/admin/PostWssTrade.php", JSON.stringify(wssdata), function(jsondata) {})
        }
    ...
    function initializeClock(cl, endtime) {
        ...
        function updateClock() {
            ...
            if(t.seconds == 2){
                ...
                $.post("php/api/admin/getGameResservedMinUpdate.php", JSON.stringify(unixtime), function(jsondata) {
            ...
            if(t.seconds == 0){
                ...
                $.post("php/api/admin/postGameResultUpdate.php", JSON.stringify(unixtime), function(jsondata) {
                    //console.log(jsondata)
                });
                ///////game result
                $.post("php/api/admin/getGameResult.php", JSON.stringify(unixtime), function(jsondata) {
            ...
            if(t.seconds == 59){
                betRemDisabled();
                var unixtime = convertUnixtoUnix(moment().subtract(1, 'minutes'));
                $.post("php/api/admin/postbettingTransaction.php", JSON.stringify(unixtime), function(jsondata) {
                    //console.log(jsondata)
                });
            }
            if(t.seconds == 57){
                ...
                $.getJSON("https://api.binance.com/api/v3/klines?symbol=BTCUSDT&interval=1m&limit=200", function(jsondata) {
                    ...
                    $.post("php/api/admin/PostWsskline.php", JSON.stringify(biApidata), function(jsondata) {})
                })
            }
            if(t.seconds == 56){
