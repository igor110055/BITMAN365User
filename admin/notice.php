<?php
    $scriptjs = array(
        "../assets/js/admin/notice_ad.js"
    );
?>
<?php include __DIR__ . '/includes_2/header.php';?>
<style>
    table.notice_ad tr th{
        background: #444444;
        padding: 12px 12px;
        font-size: 18px;
    }
    table.notice_ad tr td{
        padding: 5px 5px;
        font-size: 16px;
    }
                ...
                <div class="data_list">
                    <div style="padding: 7px 7px;">
                        ...
                        <div class="pull-right" style="padding-top: 0; padding-bottom: 0;">
                            <button type="button" class="btn modal-notice_add_show" style="background: #0093FF; color: #FFFFFF;">공지등록</button>
