...
<style>
    ...
    .modal_faq_template .btn-faq_save{
        background: #0093FF;
        border-radius: 5px;
        width: 80px;
        color: #FFFFFF;
    }
    .modal_faq_template .m_footer{
        background: #666666;
    }
    .modal_faq_template .modal-content{
        background: #333333;
        border: 4px solid #888888;
        box-sizing: border-box;
        border-radius: 10px;
    }
    .modal_faq_template .modal-body .card-body{
        padding: 0;
    }
    .modal_faq_template .modal-body .card-header{
        background: #000000;
        border-radius: 5px 5px 0px 0px;
        color: #FF9300;
        font-size: 20px;
    }
    .modal_faq_template .modal-body tr td{
        background: #444444;
    ...
    .modal_faq_template .modal-body .noticeguide_input{
        background: #FFFFFF;
        border-radius: 5px;
        height: 35px;
        width: 100%;
    ...
    .modal_faq_template .modal-body tr td select {
        -webkit-appearance: none;
        appearance: none;
    }
    .modal_faq_template .modal-body tr td .select-wrapper {
        position: relative;
    }

    .modal_faq_template .modal-body tr td .select-wrapper::after {
        content: "▼";
        font-size: 1rem;
        color: #444444;
        top: 10px;
    ...
    .modal_faq_template .btn-noticeguide_save{
        background: #0093FF;
        border-radius: 5px;
        color: #FFFFFF;
        width: 120px;
    ...
    .modal_faq_template .summer_body{
        padding: 5px 5px;
    }
</style>
                ...
                <div class="data_list">
                    <div style="padding: 7px 7px;">
                        ...
                        <div class="pull-right" style="padding-top: 0; padding-bottom: 0;">
                            <button type="button" class="btn modal-faq_add_show" style="background: #0093FF; color: #FFFFFF;">공지등록</button>
